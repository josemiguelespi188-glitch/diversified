                  ...
                  {fundingMethod === 'WIRE' && (
                    <div className="p-6 border-t border-white/5 bg-black/20 space-y-4 animate-in slide-in-from-top-2">
                       <div className="grid grid-cols-2 gap-4">
                          ...
                          <DetailItem label="Beneficiary" value="DIVERCFLY HOLDINGS LLC" />
                  ...
                  {fundingMethod === 'ACH' && (
                    <div className="p-6 border-t border-white/5 bg-black/20 space-y-4 animate-in slide-in-from-top-2">
                       ...
                       <div className="text-[9px] text-[#8FAEDB] italic uppercase opacity-60">
                         "I authorize DiverCfly to initiate a one-time ACH debit from the account above for the total allocation amount."
                       </div>
                    </div>
                  )}
                </div>
